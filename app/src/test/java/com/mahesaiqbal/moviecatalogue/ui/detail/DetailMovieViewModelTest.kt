...
//    var movieViewModel: DetailMovieViewModel? = null
//    var dummyMovies: Movies? = null
//
//    @Before
//    fun setUp() {
//        movieViewModel = DetailMovieViewModel()
//        movieViewModel!!.setTitleMovieValue("The Lion King")
//        dummyMovies = Movies(
//            "The Lion King",
...
//    @Test
//    fun getMovie() {
//        movieViewModel!!.titleMovie = dummyMovies!!.title
//
//        val movies: Movies = movieViewModel!!.getMovies()
//
